    ...
    for split in ["train", "test"]:
        ...
        for i, example in enumerate(dataset[split]):
            ...
            for start in range(0, len(enc), seq_len):
                ...
                # For grouping: here we can group 1000 chunks per group
                if len(all_inputs) % 1000 == 0:
...
# Example usage:
prepare_nlp_dataset_split("wikitext", text_field="text", model_name="gpt2", seq_len=128)
